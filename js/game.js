class Game{
    ...
    showRank() {
        ...
        swal({
            title: `${"\n"}Posición${"\n"}${player.rank}`,
            text: "¡fin del juego!",
            imageUrl:  "https://media.istockphoto.com/vectors/game-over-comic-speech-bubble-style-vector-illustrationjpg-vector-id1169155347?k=20&m=1169155347&s=612x612&w=0&h=eT4Jpj5ZqBu1oFS5Fv2rXPhvq_Q0JUIiPcvae1P3sVI=",
            imageSize: "100x100",
